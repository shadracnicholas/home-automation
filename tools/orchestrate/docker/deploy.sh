...
ssh -t -oStrictHostKeyChecking=no -oUserKnownHostsFile=/dev/null "$TARGET_USERNAME"@"$DEPLOYMENT_TARGET" << EOF
    ...
    docker build -f ./$SERVICE/\$DOCKER_FILE -t localhost:6000/shadracnicholas/home-automation-$DASHES:\$HASH --rm --pull .
    docker push localhost:6000/shadracnicholas/home-automation-$DASHES:\$HASH

    echo "Pulling new image..."
    cd /volume1/docker/home-automation/
    docker pull localhost:6000/shadracnicholas/home-automation-$DASHES:\$HASH
